...
\fancyfoot{}
\fancyhead{}
\fancyfoot[C]{Kuya Takami -- Page \thepage\ of \pageref{LastPage} -- Curriculum Vitae}
\pagestyle{fancy}
\newcommand{\job}[6]{
	\begin{tabbing}
		\hspace{2cm} \= \kill
...
\parbox{0.4\textwidth}{ % Second block
	\begin{tabbing} % Enables tabbing
		...
		\> Updated: March 07, 2016 \\ % Home phone
...
\section*{TECHNICAL STRENGTH}\vspace{-3mm}\rhead{Takami-CV}
\begin{tabbing}
	\hspace{0cm} \= \kill
